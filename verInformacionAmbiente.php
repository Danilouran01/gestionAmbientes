...
<body>
    ...
    <div class="herencia">
        ...
        <h4>Cantidad de mesas: <?php echo $informacion['mesas']; ?></h4>
        <h4>Linea formación: <?php echo $informacion['nombre_linea']; ?></h4>
...
if (resultado !== null && resultado === 'true') {
  const mensaje = '¡Elementos asociados correctamente!';
  setTimeout(function() {
    alert(mensaje);
  }, 500);
}
