...
if (isset($_REQUEST['cedula'])) {
    ...
    if (!empty($_REQUEST['fechaInicio']) || !empty($_REQUEST['fechaFin'])) {
        $datosUsuario = $prestamoActivo->obtenerPrestamosElementosUsuarioFecha($cedula, $_REQUEST['fechaInicio'], $_REQUEST['fechaFin']);

    }else{
        $datosUsuario = $prestamoActivo->obtenerPrestamosElementosUsuarioIdPrestamo($cedula);
