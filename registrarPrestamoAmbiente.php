                ...
                if (!isset($_REQUEST['consultar'])) { ?>
                    ...
                    if ($usuarios_filtrados->num_rows < 1) {
                        ...
                        if ($resultadoPrestamoActivo->num_rows > 0) {
                            ...
                            ?>
                            <form action="./procesoRegistrarPrestamoAmbiente.php" method="post">
...
<div style="display: flex; justify-content: center;">
    ...
    var serialprestamo = urlParams.get('id_prestamo');

    if (serialprestamo !== null) {
        setTimeout(function() {
            var mensaje = "Datos registrados exitosamente, id_prestamo: " + serialprestamo;
            alert(mensaje);
        }, 500);
    }
</script>
