...
// registro Fallido
    ...
    var urlParams = new URLSearchParams(window.location.search);
    var idElemento = urlParams.get('idElemento');

    if (idElemento !== null) {
        setTimeout(function() {
            var mensaje = "Elemento " + idElemento + " registrado exitosamente";
            alert(mensaje);
        }, 500);
    }
    ...
    var urlParams = new URLSearchParams(window.location.search);
    var serial_elemento = urlParams.get('serialElemento');

    if (serial_elemento !== null) {
        setTimeout(function() {
            var mensaje = "Elemento " + serial_elemento + " eliminado con éxito";
            alert(mensaje);
        }, 500);
    }
</script>
