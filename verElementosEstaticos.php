    ...
    <div class="herencia">
        ...
        <div class="contenido-ml">
            ...
            <div style="margin: 5px;">
                ...
                <form action="./excelElementosEstaticos.php" method="post" enctype="multipart/form-data">
...
if (urlParams.has('eliminar') && urlParams.get('eliminar') === 'true') {
  const mensaje = "¡Elemento eliminado correctamente!";
...
if (urlParams.has('modificar') && urlParams.get('modificar') === 'false') {
  const mensaje = "¡No se ha modificado el elemento!";
